...
public class Main extends JFrame {
	...
	public Main() {
		...
		cmbStartMonth.addItem("ENERO");
		cmbEndMonth.addItem("ENERO");
		cmbStartMonth.addItem("FEBRERO");
		cmbEndMonth.addItem("FEBRERO");
		cmbStartMonth.addItem("MARZO");
		cmbEndMonth.addItem("MARZO");
		cmbStartMonth.addItem("ABRIL");
		cmbEndMonth.addItem("ABRIL");
		cmbStartMonth.addItem("MAYO");
		cmbEndMonth.addItem("MAYO");
		cmbStartMonth.addItem("JUNIO");
		cmbEndMonth.addItem("JUNIO");
		cmbStartMonth.addItem("JULIO");
		cmbEndMonth.addItem("JULIO");
		cmbStartMonth.addItem("AGOSTO");
		cmbEndMonth.addItem("AGOSTO");
		cmbStartMonth.addItem("SEPTIEMBRE");
		cmbEndMonth.addItem("SEPTIEMBRE");
		cmbStartMonth.addItem("OCTUBRE");
		cmbEndMonth.addItem("OCTUBRE");
		cmbStartMonth.addItem("NOVIEMBRE");
		cmbEndMonth.addItem("NOVIEMBRE");
		cmbStartMonth.addItem("DICIEMBRE");
		cmbEndMonth.addItem("DICIEMBRE");
